  ...
  return (
    <div className="eyes w-full h-screen overflow-hidden">
      <div
        ...
        className="relative w-ful h-full bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1504333638930-c8787321eee0?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]"
      >
